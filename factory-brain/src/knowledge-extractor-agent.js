...
exports.KnowledgeExtractorAgent = void 0;
...
class KnowledgeExtractorAgent {
    ...
    async extractAndStoreKnowledge(appName, saasDescription, generatedTheme, generatedBlueprint, generatedLandingPage, generatedGrowthPlan) {
    ...
    **Generated Growth Plan (AI Growth Hacker Agent):**
    ...
    Provide the summary in Markdown format.`;
        ...
        if (summarizedContent) {
            ...
            logger_1.logger.info(`Knowledge for ${appName} extracted and stored in RAG.`);
        }
        else {
            logger_1.logger.warn(`Failed to summarize knowledge for ${appName}. Not storing.`);
        }
    }
}
exports.KnowledgeExtractorAgent = KnowledgeExtractorAgent;
//# sourceMappingURL=knowledge-extractor-agent.js.map