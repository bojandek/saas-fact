...
exports.LegalTermsGenerator = exports.LEGAL_AGENT_PROMPT = void 0;
/**
...
Object.defineProperty(exports, "LEGAL_AGENT_PROMPT", { enumerable: true, get: function () { return agent_prompts_1.LEGAL_AGENT_PROMPT; } });
class LegalTermsGenerator {
    /**
     * Generate Privacy Policy (GDPR compliant)
     */
    static generatePrivacyPolicy(config) {
        const content = `
# Privacy Policy
...
**Jurisdiction:** ${config.jurisdiction}
     ...
     */
    static generateTermsOfService(config) {
        const content = `
# Terms of Service
...
**Jurisdiction:** ${config.jurisdiction}
     ...
     */
    static generateDataProcessingAgreement(config) {
        const content = `
...
**Effective Date:** ${new Date().toLocaleDateString()}
     ...
     */
    static generateAllDocuments(config) {
        return [
     ...
     * Helper functions
     */
    static formatDataType(dataType) {
    ...
    static getServiceDescription(service) {
        const descriptions = {
...
exports.LegalTermsGenerator = LegalTermsGenerator;
//# sourceMappingURL=legal-terms-generator.js.map