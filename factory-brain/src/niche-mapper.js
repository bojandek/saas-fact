...
class NicheMapper {
     ...
     */
    buildBlueprint(niche, data, confidence) {
     ...
     */
    async mapNicheWithLLM(niche, normalized) {
...
exports.NicheMapper = NicheMapper;
//# sourceMappingURL=niche-mapper.js.map