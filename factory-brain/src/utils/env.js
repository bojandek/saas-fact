...
const envSchema = zod_1.z.object({
    ...
    NEO4J_URI: zod_1.z.string().url().optional(),
    NEO4J_USERNAME: zod_1.z.string().optional(),
    NEO4J_PASSWORD: zod_1.z.string().optional(),
    STRIPE_SECRET_KEY: zod_1.z.string().startsWith('sk_').optional(),
    STRIPE_WEBHOOK_SECRET: zod_1.z.string().startsWith('whsec_').optional(),
    COOLIFY_API_KEY: zod_1.z.string().optional(),
    COOLIFY_BASE_URL: zod_1.z.string().url().optional(),
});
/**
